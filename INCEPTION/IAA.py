...
if __name__ == '__main__':
    round_1_kappa = clac_IAA('inception_round_1/multi_tagger_round_1.csv', ignore_vague=False)
    round_1_kappa_ignore_vague = clac_IAA('inception_round_1/multi_tagger_round_1.csv', ignore_vague=True)

    round_2_kappa = clac_IAA('inception_round_2/multi_tagger_round_2.csv', ignore_vague=False)
    round_2_kappa_ignore_vague = clac_IAA('inception_round_2/multi_tagger_round_2.csv', ignore_vague=True)
